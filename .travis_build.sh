...
clang++ -std=c++1y -pthread -g -Wall -Wextra  -c -o tests/mat_generator.o sources/mat_generator.hpp
...
clang++ -std=c++1y -pthread -g -Wall -Wextra -isystem tests/googletest/googletest/include  -c -o tests/mat_generator_test.o tests/mat_generator_test.cpp
echo "Done compiling kmosaic_test.cpp"
clang++ -std=c++1y -g -Wall -Wextra -o tests/gtest tests/mat_generator.o tests/main.o tests/mat_generator_test.o -pthread -Ltests/ -lgtest -lopencv_core
